...
# Retorno de cada método da classe BESS no C++
...
_lib.bess_daily_energy.argtypes = [ctypes.POINTER(_BESS)]
_lib.bess_daily_energy.restype = ctypes.c_double

_lib.bess_monthly_energy.argtypes = [ctypes.POINTER(_BESS)]
_lib.bess_monthly_energy.restype = ctypes.c_double

_lib.bess_get_result_at.argtypes = [ctypes.POINTER(_BESS), ctypes.c_int]
_lib.bess_get_result_at.restype = ctypes.c_double
